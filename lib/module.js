...
export default class Module{
        ...
        switch (req.method){
            ...
            case "GET":
                ...
                switch (await (async () => {
                    ...
                    case true:
                        if(req.headers.jside === "acces") res.status(200).send() 
    ...
    get(path, fnc, httpAcces){
        ...
        this.#modulesGET[this.name + path] = {
            fnc: fnc,
            httpAcces: httpAcces? 
                (async (req, res) => {return await httpAcces(req, res, async () => {return await this.#httpAcces(req , res)})}) : 
    ...
    addPage(page, json){
        ...
        page.module = this.name
        page.rootIndex = this.root.index
        page.render(json, this.component)
