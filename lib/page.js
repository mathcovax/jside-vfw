        ...
        while((page.document.querySelector("div[data-mc]") && module) || page.document.querySelector("div[data-ec]")){
            ...
            for(const component of page.document.querySelectorAll("div[data-ec]")){
                if(component.dataset.ec.endsWith(".*")){
                    ...
                    let div = page.document.createElement("div")
                    if((this.module?.root?.extComponent || root.extComponent)[component.dataset.ec]){
                        div.innerHTML = (this.module?.root?.extComponent || root.extComponent)[component.dataset.ec].render(component.innerHTML === ""? false : component.innerHTML)
                        if(this.module?.root?.extComponent){
                            this.module.root.extComponent[component.dataset.ec].page.push({
                                type: "root",
                                module: this.module.name,
                                page: this.name,
                                url: "/" + this.module.name + (this.name != this.module.name && this.name != "$"? this.name : "")
                            ...
                            root.extComponent[component.dataset.ec].page.push({
                                type: "restart",
                            })
                        }
