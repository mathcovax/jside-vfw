class component{
    constructor(div, body={}){
        ...
        this.#div.innerText = this.#div.innerHTML == ""? "Chargement du composant..." : this.#div.innerText
        this.#id = Date.now()
    ...
    async #request(body){
        return new Promise((resolve, reject) => {
            fetch(window.location.origin + "/jside/component/" + this.#path + "/" + this.#name + this.#arg, {
                method: "POST",
                headers: {
    ...
    static launch(){
        while(document.getElementById("component")){
            ...
            _component.id = ""
            component.list[_component.dataset.name] = new component(_component)
        }
    }
